...
st.write("### Add Job Source")

source_type = st.selectbox(
    "Source Type",
    ["Company URL", "RSS Feed", "Job Board"]
)

source_link = st.text_input("Source URL")

if st.button("Add Source"):
    st.success("Source added successfully. It will be used in the next refresh.")